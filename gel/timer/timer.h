...
typedef struct timer_struct {
    ...
    void (*callback)(struct timer_struct *, void *);
    void *arg;
} timer_t;

typedef void (*timer_callback_t)(timer_t *, void *);




void timer_activate(timer_t *timer, unsigned long period, unsigned long millis, timer_callback_t cb, void *arg);
