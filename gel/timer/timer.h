...
#define GEL_TIMER_NULL ((gel_timer_t){.active = 0, .autoreload = 0, .stopwatch = STOPWATCH_NULL, .callback = NULL, .arg = NULL})
...
gel_timer_t *gel_timer_activate(gel_timer_t *timer, unsigned long period, unsigned long millis, gel_timer_callback_t cb, void *arg);
