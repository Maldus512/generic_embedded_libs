...
enum enqueue_result_t {
  ENQUEUE_RESULT_SUCCESS,
  ENQUEUE_RESULT_FULL,
};

enum dequeue_result_t {
...
enum enqueue_result_t NAME ##_enqueue(struct NAME * p_queue, ITEM_TYPE * p_new_item);     \
enum dequeue_result_t NAME ##_dequeue(struct NAME * p_queue, ITEM_TYPE * p_item_out);     \
